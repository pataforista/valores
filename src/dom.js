...
export const el = {
    ...
    tabLeaves: document.getElementById("tab-leaves"),
    ...
    viewLeaves: document.getElementById("view-leaves"),
    viewExposure: document.getElementById("view-exposure"),
